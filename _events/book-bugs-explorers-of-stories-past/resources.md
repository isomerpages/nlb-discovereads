...
<iframe width="560" height="315" src="https://www.youtube.com/embed/1xv9sKoci0E" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
### Book Lists
Want to read the stories behind each Book Bug? You can read the ultimate guide written by your navigators - [*An Explorer's Guide to Book Bugs: Explorers of Stories Past*](http://catalogue.nlb.gov.sg/cgi-bin/spydus.exe/ENQ/WPAC/BIBENQ?SETLVL=1&BRN=205500256) or you can pick up the books on the lists below at the public libraries! Some of the books are compilations of various stories - discover a whole world of stories when you read them to find the story behind each Bug! Click on the title of each book to find out where you can borrow a copy.
