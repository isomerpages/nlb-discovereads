...
<h4>LET'S INVESTIGATE!</h4>
 ...
 <h5>PH Scale worksheet</h5>
<div class="row is-multiline margin--bottom--lg">
 <div class="col is-two-fifths">
    <div class="image">
  <a href="https://go.gov.sg/earlyreadbuddingscientists-phscale" target="_blank"><img src="/images/science-lfa/Potions%20party/PH%20Scale%20worksheet%20(Jade).png" style="width:3=300px; text-align:left;"></a>
     </div>
   </div>
 <div class="col is-three-fifths">
	<p>Materials required are coloured markers/pencils, scissors and glue. <br><br> Click on the image to retrieve the PH Scale worksheet. Find out more during our programme! </p>
	    </div>
 </div>
